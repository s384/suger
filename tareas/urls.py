...
from .views import (TareasList,TareasCreate,informe_tareas,
                    ...
                    TareasDetail, TareasComplete, TareasListHistorico)
urlpatterns = [
    #Solicitud de tareas
	...
	#Tareas
    path('listado-tareas', TareasList.as_view(), name="listTareas"),
    path('tareas-historico', TareasListHistorico.as_view(), name="TareasListHistorico"),
